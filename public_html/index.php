		...
		<body>
			...
			<div class="bg-2 text-center">
				<div class="container-fluid">
					...
					<div class="colorBlock2"><p class="textBlock2">I learned web development through a boot camp I took in ABQ is called, <a href="https://bootcamp-coders.cnm.edu/" style="color: #484848" target="_blank">Deep Dive Coding</a> and here is the link to apply for the camp, <a href="https://stemuluscenter.org/" style="color: #484848" target="_blank">The STEMulus Center</a>. This is where I learned full stacked web development as a developer. I learned HTML5, Javascript, Angular2, mySQL, PHP, CSS3, Bootstrap, Git, and Jquery. Through this boot camp, I made a capstone that encompassed all material taught in class. Also built a full static website you see here with HTML5 and CSS3.<br><br>I'm also proficient video editor. I mainly use Final Cut Pro X, Logic Pro X, Motion 5, and  Compressor 4. I learned using all these programs in college and through film projects of my own. I'm also a proficient photoshop editor. I learned this through being an editor for my friends journal comic.</p></div>

					<h2 class="margin">Life</h2>
					<div class="colorBlock3"><p class="textBlock3"></p></div>
